...
@interface CPADetailViewController : UITableViewController
<UIActionSheetDelegate,UITextFieldDelegate,UITextViewDelegate,CLLocationManagerDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIAlertViewDelegate>
{
    ...
    //for passing object from draftView into detailView
    CPAReport *passingReportObj;
...
@property (nonatomic, retain) CPAReport *passingReportObj;
